...
## Ограничения ответа (важно для стабильности)
- Включай не более 40 сцен с нарушениями в массив scenes (самые значимые).
- Поля reason и quote — до 200 символов каждое.
- entities — не более 30 записей.
- age_rating_triggers — не более 15 записей.
- Если нарушений нет — верни пустой массив scenes, но заполни recommended_age_rating.
