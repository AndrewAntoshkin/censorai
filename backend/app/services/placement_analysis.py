...
- description — что происходит в сцене (1–2 предложения)
- object_detail — что видно в кадре, связанное с запросом (форма, цвет, где лежит)
...
- confidence — 0.0–1.0
- editor_note — краткая заметка монтажёру (статичный план, движение руки, мелькнуло и т.д.)
